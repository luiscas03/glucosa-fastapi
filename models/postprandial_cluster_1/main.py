...
logger = logging.getLogger("postprandial_cluster_1")
...
MODEL_PATH = BASE_DIR / "model_cluster_1.joblib"
ISO_PATH = BASE_DIR / "iso_cluster_1.joblib"
...
app = FastAPI(
    title="Postprandial Cluster 1 API",
    version="1.0.0",
    description="Servicio individual para model_cluster_1.joblib",
)
...
def health():
    return {
        ...
        "service": "postprandial_cluster_1",
        "model_variant": MODEL_VARIANT,
