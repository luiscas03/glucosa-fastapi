...
logger = logging.getLogger("cnn_lstm_p001_p002_v1")

API_KEY_NAME = "X-API-Key"
api_key_header = APIKeyHeader(name=API_KEY_NAME, auto_error=True)
API_KEY = os.getenv("API_KEY")

MODEL_PATH = BASE_DIR / "glucose_cnn_lstm_p001_p002_v1.keras"
tf: Any = None
...
app = FastAPI(
    title="CNN LSTM P001 P002 V1 API",
    version="1.0.0",
    description="Servicio individual para glucose_cnn_lstm_p001_p002_v1.keras",
)
