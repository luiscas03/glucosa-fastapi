# Postprandial Global M1 API

## Run Local

```bash
uvicorn models.postprandial_global_m1.main:app --host 0.0.0.0 --port 8002
```
...
- Usa `model_global_m1.joblib`
- `iso_global_m1.joblib` no es otro predictor: es un calibrador opcional que ajusta el score final
