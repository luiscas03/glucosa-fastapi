...
logger = logging.getLogger("postprandial_global_m1")
...
MODEL_PATH = BASE_DIR / "model_global_m1.joblib"
ISO_PATH = BASE_DIR / "iso_global_m1.joblib"
...
app = FastAPI(
    title="Postprandial Global M1 API",
    version="1.0.0",
    description="Servicio individual para model_global_m1.joblib",
)
...
def health():
    return {
        ...
        "service": "postprandial_global_m1",
        "model_variant": MODEL_VARIANT,
